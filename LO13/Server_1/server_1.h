...
private:
    ...
    void write_element_to_socket(element_array_type& data_array, size_t count);
    void send_standard_table(size_t level, size_t rec_ele_num);
    void send_cuckoo_table(size_t level, size_t rec_ele_num);
    void receive_standard_table(size_t level, std::vector<element_array_type>& element_array);
    void receive_cuckoo_table(size_t level, std::vector<element_array_type>& element_array);
